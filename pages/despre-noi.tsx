...
const DespreNoi = ({ menuItems, jobCategories }) => {
  ...
  return (
    <>
      <MetaHead
        title="Despre noi | Job Dating"
        description="Servicii de leasing personal , recrutare și selecție forță de muncă, administrare personal și consultanță în domeniul legislației muncii."
            ...
            <div className="p-8 md:w-1/2 w-full relative z-10">
              <div className="flex flex-col font-inter text-gray-500 leading-loose">
                <p className="font-medium">
                  ...
                  plus valoare în companiile clienților noștri și în același
                  timp de a încadra candidații aflați în căutarea unui loc de
                  muncă, pe posturi ce li se potrivesc cel mai bine.
                </p>
                <p className="py-2">
                  ...
                  varietate de soluții care acoperă întreg ciclul de management
                  al resurselor umane, precum leasing personal (muncă
                  temporară), recrutare și selecție forță de muncă, administrare
                  personal și consultanță în domeniul legislației muncii.
                </p>
                <p className="py-2">
                  Dispunem de o{" "}
