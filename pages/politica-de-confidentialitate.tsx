...
const PoliticaDeConfidentialitate = ({ menuItems, jobCategories }) => {
  ...
  return (
    <>
      <MetaHead
        title="Politica de confidențialitate | Job Dating"
        description=""
        ...
        <div className="container mx-auto px-4 py-16 text-gray-500 leading-normal">
          <section className="mb-8 leading-normal">
            ...
            <p className="font-normal">
              ...
              acestor date (în continuare „Regulamentul”) va fi aplicat de toate
              statele Uniunii Europene. Prin intermediul acestui Regulament se
              dorește crearea unui cadru legislativ unitar și uniform pe
              teritoriul Uniunii Europene care să nu mai necesite măsuri
          ...
          <section className="mb-8">
            ...
            <p className="font-normal">
              ...
              Regulament, și având în vedere că protecția datelor dvs reprezintă
              o preocupare majoră și constantă pentru noi, am elaborat prezentul
              ...
              <span className="font-semibold">
                scopul și temeiul prelucrării, durata prelucrării, unde păstrăm
                și cui transmitem aceste date
              </span>
              , precum și{" "}
              <span className="font-semibold">
          ...
          <section className="mb-8">
            ...
            <p className="font-normal">
              ...
              („persoana vizată”); o persoană fizică identificabilă este o
              persoană care poate fi identificată, direct sau indirect, în
              ...
              specifice, proprii identității sale fizice, fiziologice, genetice,
              psihice, economice, culturale sau sociale.
            </p>
            <p className="font-normal">
              <strong>„prelucrare”</strong> înseamnă orice operațiune sau set de
              operațiuni efectuate asupra datelor cu caracter personal sau
              asupra seturilor de date cu caracter personal, cu sau fără
              utilizarea de mijloace automatizate, cum ar fi colectarea,
              ...
              transmitere, diseminarea sau punerea la dispoziție în orice alt
            ...
            <p className="font-normal">
              ...
              împreună cu altele, stabilește scopurile și mijloacele de
              prelucrare a datelor cu caracter personal; atunci când scopurile
              și mijloacele prelucrării sunt stabilite prin dreptul Uniunii sau
              dreptul intern, operatorul sau criteriile specifice pentru
              desemnarea acestuia pot fi prevăzute în dreptul Uniunii sau în
              dreptul intern;
            </p>
            <p className="font-normal">
            ...
            <p className="font-normal">
              <strong>„destinatar”</strong> înseamnă persoana fizică sau
              juridică, autoritatea publică, agenția sau alt organism căreia
              (căruia) îi sunt divulgate datele cu caracter personal, indiferent
              dacă este sau nu o parte terță.
            </p>
            <p className="font-normal">
            ...
            <p className="font-normal">
              JOB DATING S.R.L în calitate de operator, prelucrează datele
              într-un mod care asigură securitatea adecvată a datelor cu
              caracter personal.
            </p>
          </section>
          <section className="mb-8">
            ...
            <p className="font-normal">
              În general prelucrăm următoarele date cu caracter personal ale
              dvs.:
            </p>
            ...
            <p className="font-normal">
              ...
              ce urmează modul în care prelucrăm datele tale, scopurile și
              temeiul juridic (baza legală) al activităților prin care prelucrăm
              datele tale.
            </p>
          </section>
          <section className="mb-8">
            ...
            <p className="font-normal">
              Pentru a vă putea contacta în legătură cu produsele JOB DATING
              S.R.L aveți posibilitatea să completați formularul de contact pus
              la dispoziție pe{" "}
              <span className="font-semibold">www.jobdating.ro</span> la
              secțiunea
            ...
            <p className="font-normal">
              <strong>
                ...
                interesul legitim al societății de a face recrutări de personal
                în vederea punerii la dispoziția unor terți. Datele dvs. nu vor
                putea fi folosite în alte scopuri și nici nu vor putea face
                obiectul unor decizii automate bazate exclusiv pe prelucrarea
                automată, inclusiv profilare.
              </strong>
            </p>
            <p className="font-normal">
              Datele dvs. cu caracter personal vor fi păstrate de JOB DATING
              S.R.L pe o perioadă de 1 an. Datele dvs. prelucrate la momentul
              ...
              profiluri, nu vor fi divulgate niciunui terț și nu vor face
              obiectul unul transfer către o țară terță sau o organizație
              internațională.
            </p>
          </section>
          <section className="mb-8">
            ...
            <p className="font-normal">
              <strong>
                ...
                reprezintă interesul legitim al societății de a face recrutări
                de personal în vederea punerii la dispoziția unor terți. JOB
                DATING S.R.L va păstra datele dvs. pe o perioadă de 1 an de la
                data primirii CV-ului. Scopul prelucrării datelor îl reprezintă
            ...
            <p className="font-normal">
              ...
              corespunzătoare de securitate și că nu vor putea fi folosite în
              alte scopuri decât cele prezentate.
            </p>
            <p className="font-normal">
          ...
          <section className="mb-8">
            ...
            <p className="font-normal">
              ...
              foloseşte cookie-uri de sesiune (obligatorii). Cookie-ul
              reprezinta un fisier de tip „.txt”, oferite browser-ului dvs. de
              un server web, ce poate fi plasat pe hard disk-ul dvs. Majoritatea
              browserelor sunt setate să accepte aceste cookie-uri. Dacă nu
              doriți acest lucru, puteți reseta browser-ul dvs., să fiți
              anunțați de fiecare dată când primiți câte un cookie sau să refuze
              acceptarea acestor cookie-uri
            </p>
            <p className="font-normal">
            ...
            <p className="font-normal">
              ...
              aplicaţii ale site-ului, fapt care le permite ulterior
              îmbunătăţirea experinţei de navigare, introducerea unui conţinut
          ...
          <section className="mb-8">
            ...
            <p className="font-normal">
              ...
              prelucrate într-un mod are asigură securitatea adecvată a datelor
            ...
            <p className="font-normal">
              ...
              completării datelor personale pe site-ul nostru, informaţiile vor
              fi protejate atât offline cât şi online.
            </p>
          </section>
          <section className="mb-8">
            <h1 className="text-3xl font-normal mb-4 text-cyan-900">
            ...
            <p className="font-normal">
              <strong>
                ...
                drepturi în vederea garantării protecției datelor dvs. cu
                caracter personal:
              </strong>
            </p>
            <p className="font-normal">
              ...
              pentru care se preconizează că vor fi stocate sau, dacă acest
              lucru nu este posibil, criteriile utilizate pentru a stabili
              această perioadă; existența unui proces decizional automatizat
            ...
            <p className="font-normal">
              ...
              destinatar la care au fost transmise datele, cu excepția cazului
            ...
            <p className="font-normal">
              ...
              următoarele situații: dacă ați contestat exactitatea datelor,
              pentru o perioadă care ne permite să verificam exactitatea
              datelor; dacă prelucrarea este ilegală, iar dvs. vă opuneți
              ștergerii datelor cu caracter personal, solicitând în schimb
              restricționarea utilizării lor; dacă subscrisa nu mai am nevoie de
              datele cu caracter personal în scopul prelucrării, dar le
              solicitați pentru constatarea, exercitarea sau apărarea unui drept
              în instanță; dacă v-ați opus prelucrării pentru intervalul de timp
              în care se verifică dacă drepturile legitime ale operatorului
            ...
            <p className="font-normal">
              ...
              există niciun alt temei juridic pentru prelucrarea; dacă vă
              opuneți prelucrării și nu există motive legitime care să prevaleze
              în ceea ce privește prelucrarea; datele cu caracter personal au
              fost prelucrate ilegal; datele cu caracter personal trebuie șterse
              pentru respectarea unei obligații legale; datele cu caracter
            ...
            <p className="font-normal">
              ...
              aveți dreptul să vă opuneți în orice moment prelucrării datelor
              dvs. în scop de marketing direct, inclusiv creării de profiluri,
              în acest caz datele dvs. vor fi șterse.
            </p>
          </section>
          <section className="mb-8">
            <h1 className="text-3xl font-normal mb-4 text-cyan-900">
            ...
            <p className="font-normal">
              Prezenta informare a dvs. este limitată la pagina noastră web și
              nu este valabilă pentru paginile web ale operatorilor terți, care
              pot fi accesate prin intermediul acestei pagini web. Nu avem nicio
              influență asupra prelucrării datelor de către acești operatori
              terț și nu ne asumăm nicio responsabilitate sau răspundere în
